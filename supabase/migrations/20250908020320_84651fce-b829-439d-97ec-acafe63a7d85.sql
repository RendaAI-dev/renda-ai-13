-- ==================== CORREÇÃO DA SINCRONIZAÇÃO DE PLANOS ====================
-- Problema: current_plan_type não atualiza quando o usuário troca de plano
-- Causa: função sync_user_current_plan usa valores hardcoded
...
-- Etapa 3: Executar a correção dos dados existentes
SELECT * FROM public.fix_subscription_plan_sync();

-- Etapa 4: Verificar se o trigger está ativo
