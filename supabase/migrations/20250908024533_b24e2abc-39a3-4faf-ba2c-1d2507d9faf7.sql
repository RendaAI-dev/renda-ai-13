-- Remover funções antigas e recriar com nova estrutura
...
-- Recriar função get_user_subscription_status para usar poupeja_users
...
-- Recriar função update_subscription_status para usar poupeja_users
